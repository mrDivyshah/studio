...
import { OWNER_NAME, OWNER_BIO, BUSINESS_HISTORY, BUSINESS_MISSION, BUSINESS_VALUES, TESTIMONIALS } from '@/lib/constants';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Star, CheckCircle } from 'lucide-react';

export const metadata: Metadata = {
  title: 'About Us',
  description: `Learn about ${OWNER_NAME}'s story, our mission, values, and what our customers say about us.`,
};
  ...
  return (
    <div className="space-y-16 py-8">
      <section className="text-center">
        <h1 className="font-headline text-4xl font-bold mb-4">About Electro Hub</h1>
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
          Discover the story behind Electro Hub, our commitment to quality, and the values that drive us.
        </p>
      </section>
      ...
      <section className="bg-secondary py-16 rounded-lg">
        <div className="container mx-auto px-4">
          <h2 className="font-headline text-3xl font-bold text-center mb-10">Meet the Owner</h2>
      ...
      {TESTIMONIALS && TESTIMONIALS.length > 0 && (
        <section>
          <h2 className="font-headline text-3xl font-bold text-center mb-10">What Our Customers Say</h2>
          <div className="grid md:grid-cols-2 gap-8">
